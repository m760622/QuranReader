...
let bundledReaderFontFiles: [String] = [
    ...
    "UthmanicHafs1B Ver13.otf",
    "UthmanicQaloun V21.otf",
    "UthmanicQunbul V20.otf",
    "UthmanicShuba V20.otf",
    "UthmanicSousi V20.otf",
    "UthmanicWarsh V21.otf",
    "UthmanTN1 Ver10.otf",
    ...
    var chromeMushafPageNumber: Int {
        if isMushafPageMode {
            if let visiblePage = visibleMushafPageCandidateForChrome() {
                if let target = pendingMushafScrollTargetPage, abs(visiblePage - target) <= 1 {
                    return target
                }
                return visiblePage
            }
